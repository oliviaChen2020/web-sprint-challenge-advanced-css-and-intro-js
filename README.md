...
3. How would you explain the concept of a variable to someone new to programming?
 In JavaScript, variables are containers which hold reusable data and used in a function.

4. What is the purpose of using functions in code?
In programming, functions are used to store a piece of code that does a single task, and  you can   call that code whenever you need it.
